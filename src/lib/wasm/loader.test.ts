...
describe('jelly-wasm loader', () => {
	...
	it('parses a bare CBOR tag-200 node (generated from a minimal core)', async () => {
		// Minimal bare node: tag 200 → tag 201 → core map with the
		// six required core fields. We use a known-good byte sequence
