...
// Story 1.4 — D-030 shadow phase: legacy emits to .legacy/ so the
// byte-equivalence test can diff against the new generator's output.
const TYPES_OUT = "src/lib/generated.legacy/types.ts";
const CBOR_OUT = "src/lib/generated.legacy/cbor.ts";
const SCHEMAS_OUT = "src/lib/generated.legacy/schemas.ts";
const README_OUT = "src/lib/generated.legacy/README.md";
...
pub fn main() !void {
    ...
    // Story 1.4 — D-030 shadow phase: ensure legacy output dir exists.
    std.Io.Dir.cwd().createDirPath(io, "src/lib/generated.legacy") catch |e| switch (e) {
        error.PathAlreadyExists => {},
        else => return e,
    };
    // Emit the AC1 structured-log line for the shadow phase.
    const stderr_file = std.Io.File.stderr();
    var serr_buf: [256]u8 = undefined;
    var serr_w = stderr_file.writer(io, &serr_buf);
    try serr_w.interface.writeAll("{\"phase\":\"shadow-run\",\"new_target\":\"src/lib/generated\",\"legacy_target\":\"src/lib/generated.legacy\"}\n");
    try serr_w.interface.flush();
