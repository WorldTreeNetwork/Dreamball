...
const ARCHIFORM_OUT_PATH = "src/lib/generated/memory-palace.schemas.ts";

pub fn generate(ctx: *const main_mod.GeneratorCtx) !void {
    try ctx.writeOutput(OUT_PATH, BODY, .ts);
}

/// Per-archiform pass (Story 2.2 AC1): emits Memory Palace Valibot validators
/// to `src/lib/generated/memory-palace.schemas.ts`.
